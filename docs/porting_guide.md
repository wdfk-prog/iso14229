...
> [!NOTE]
> If your target uses linux, Windows, Arduino, esp-idf, Zephyr, or RT-Thread, consider consulting the [examples](docs/mainpage.md#examples_sec) first. This guide mainly considers embedded targets without existing support.
...
- [`rtt_server`](../examples/rtt_server/README.md)
